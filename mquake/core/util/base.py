...
ENTRY_POINTS['grid'] = _get_entry_points('mquake.io.grid', 'readFormat')
ENTRY_POINTS['grid_write'] = _get_entry_points('mquake.io.grid', 'writeFormat')

gfr_entry_points = _get_entry_points('mquake.io.waveform', 'readFormat')
gfw_entry_points = _get_entry_points('mquake.io.waveform', 'writeFormat')

wf_entry_points = _get_entry_points('mquake.io.waveform', 'readFormat')

for key in wf_entry_points.keys():
    ENTRY_POINTS['waveform'][key] = wf_entry_points[key]

wfw_entry_points = _get_entry_points('mquake.io.waveform', 'writeFormat')

for key in wfw_entry_points.keys():
    ENTRY_POINTS['waveform_write'][key] = wfw_entry_points[key]

evt_entry_points = _get_entry_points('mquake.io.event', 'readFormat')

for key in evt_entry_points.keys():
    ENTRY_POINTS['event'][key] = evt_entry_points[key]

invr_entry_points = _get_entry_points('mquake.io.inventory', 'readFormat')
