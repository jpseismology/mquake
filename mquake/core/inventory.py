...
from mquake.core.util.decorators import expand_input_format_compatibility
from mquake.core.coordinates import Coordinates, CoordinateSystem
from pathlib import Path

from .logging import logger
from mquake import __package_name__ as ns
...
from mquake.core.util.attribute_handler import set_extra, get_extra, namespace
import hashlib
...
from mquake.core.util.decorators import deprecated
...
class Instrument:
    ...
    that are Instruments. From the mquake package perspective a station is
...
def load_from_excel(file_name) -> Inventory:
    ...
    Read in a multi-sheet excel file with network metadata sheets:
        ...
        Boreholes
    Organize these into a mquake Inventory object

    :param xls_file: path to excel file
    :type: xls_file: str
    :return: inventory
    :rtype: mquake.core.data.inventory.Inventory
...
def read_inventory(path_or_file_object, format='STATIONXML',
    ...
    :rtype: ~mquake.core.inventory.Inventory
    """
