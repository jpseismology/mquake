...
class Stream(obsstream.Stream, ABC):
    __doc__ = obsstream.Stream.__doc__.replace('obspy', 'mquake')
    ...
    def composite(self):
        ...
        :type st: ~mquake.core.stream.Stream
        :rtype: ~mquake.core.stream.Stream
...
def is_valid(st_in, return_stream=False, STA=0.005, LTA=0.1, min_num_valid=5):
    """
        ...
        :param st_in: stream
        :type st_in: mquake.core.stream.Stream
        ...
        :rtype: bool or mquake.core.stream.Stream
    """
...
read.__doc__ = obsstream.read.__doc__.replace('obspy', 'mquake')
