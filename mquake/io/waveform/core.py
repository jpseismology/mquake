...
from .protobuf import mquake_pb2, convert_utc_to_grpc_timestamp
...
#     :type stream: ~mquake.core.Stream.stream
...
def read_ESG_SEGY(fname, inventory=None, **kwargs):
    ...
    :return: ~mquake.core.stream.Stream
    """
...
def read_TEXCEL_CSV(filename, **kwargs):
    """
    Reads a texcel csv file and returns a mquake Stream object.

    .. warning::
        This function should NOT be called directly, it registers via the
        mquake :func:`~mquake.core.stream.read` function, call this
        instead.
