...
from mquake.core.event import WaveformStreamID
from mquake.core.coordinates import Coordinates, CoordinateSystem
from mquake.core.inventory import Inventory
from mquake.synthetic.inventory import generate_unique_instrument_code
from mquake.core.event import ResourceIdentifier
...
class Seed:
    ...
    def random_in_grid(cls, grid: Grid, n_seeds: int = 1) -> 'List[Seed]':
        ...
        :type grid: mquake.grid.base.Grid or an object inheriting from Grid
        ...
        >> from mquake.grid.nlloc import Location
...
class SeedEnsemble:
    ...
    def from_inventory(cls, inventory: Inventory, units: GridUnits = GridUnits.METER) \
        ...
        :type inventory: mquake.core.inventory.Inventory
        :param units: units of measurement used to express x, y, and z
        :type units: str must be a valid unit of measurement as defined by the
        GridUnits class
    ...
    def generate_random_seeds_in_grid(cls, grid, n_seeds=1):
        ...
        >>> from mquake.grid.base import Grid
        >>> from mquake.grid.extended import SeedEnsemble
        >>> grid_dimensions = [10, 10, 10]
        >>> grid_spacing = [1, 1, 1]
        >>> grid_origin = [0, 0, 0]
        >>> grid = Grid(grid_dimensions, grid_spacing, grid_origin, value=1)
...
class TypedGrid(Grid):
    ...
    def mv(self, base_name, origin, destination):
        ...
        :type NLLocGridObject: mquake.grid.extended.TypedGrid
        :param base_name:
        :type base_name: str
        :param origin:
        :type origin: str
...
class LayeredVelocityModel(object):
    ...
    def __init__(self, network_code: str, velocity_model_layers: List = None,
        ...
        :param grid_id: the grid id
        :type grid_id: mquake.core.event.ResourceIdentifier
        :param coordinate_system: coordinate system either NED or ENU
        :type coordinate_system: CoordinateSystem
