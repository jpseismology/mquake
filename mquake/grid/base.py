...
from mquake.core.inventory import Inventory, Network, Station, Channel
import random
...
class Grid(object):
    ...
    def __init__(self, data_or_dims: Union[np.ndarray, List, Tuple],
        ...
        :type coordinate_system: ~mquake.core.coordinates.CoordinateSystem
...
def angles(travel_time_grid):
    ...
    :type travel_time_grid: ~mquake.core.grid.Grid.
...
def ray_tracer(travel_time_grid, event_loc, grid_space=False, max_iter=5000,
    ...
    applicable
    :type arrival_id: mquake.core.event.ResourceIdentifier
    :param velocity_model_id: velocity/earth model id.
    :type velocity_model_id: mquake.core.event.ResourceIdentifier
    :rtype: numpy.ndarray
    """

    from mquake.core.event import Ray
