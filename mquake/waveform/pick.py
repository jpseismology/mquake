# -*- coding: utf-8; -*-
#
# (c) 2016 mquake development team
#
# This file is part of the mquake library
#
# mquake is free software; you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation; either version 3 of the License, or
# (at your option) any later version.
#
# mquake is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
# GNU General Public License for more details.
#
# You should have received a copy of the GNU General Public License
# along with mquake.  If not, see <http://www.gnu.org/licenses/>.
...
def measure_polarity(st, catalog, site, average_time_window=1e-3,
    ...
    :type st: either obspy.core.Stream or mquake.core.Stream
    :param catalog: catalog object
    :type catalog: mquake.core.Catalog
    :param site: sensor information
    :type site: mquake.core.station.Site
...
def snr_repicker(st, picks, start_search_window, end_search_window,
    ...
    :param picks: list of mquake.core.event.Pick object
    picks
    :type picks: mquake.core.event.Catalog
    ...
    search window
    :returns:  Tuple comprising 1) a :py:class:`mquake.core.event.Catalog`
...
def snr_ensemble_re_picker(st, picks, start_search_window, end_search_window,
    ...
    :type st: :py:class:`mquake.core.stream.Stream`
    :param picks: list of :class:`mquake.core.event.Pick` object
    picks
    :type picks: list of :py:class:`mquake.core.event.Pick`
    :param start_search_window: start of the search window relative to
    provided picks in seconds
    :type start_search_window: float
    :param end_search_window: end of the search window relative to the
...
def extract_trace_segment(st: Stream, pick_time: UTCDateTime,
    ...
    """
        ...
        :type st: :py:class:`mquake.core.stream.Stream`
        :param pick_time: pick time
        :type pick_time: :py:class:mquake.core.UTCDateTime
